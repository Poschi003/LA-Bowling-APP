...
function normalizeOffer(offer = {}) {
  ...
  return {
    ...
    nextFollowUpDate: cleanOfferDate(offer.nextFollowUpDate),
    ...
    bmwExtraPrice: cleanOfferMoney(offer.bmwExtraPrice),
    ...
    bowling: {
      ...
      manualHourlyRate: cleanOfferMoney(bowling.manualHourlyRate),
