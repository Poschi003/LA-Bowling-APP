...
async function saveTips(body, res) {
  ...
  appData.dayReports[date] = {
    ...
    gastroCashRevenue: cleanMoney(body.gastroCashRevenue ?? existing.gastroCashRevenue),
    revenueDrinks,
    revenueFood,
    revenueOther,
    revenueGastro,
...
function defaultReport(report = {}) {
  return { cashTotal: "", cashExpenses: "", ecTerminal1: "", ecTerminal2: "", ecTotal: "", invoiceTransferAmount: "", personalConsumption: "", revenueBowling: "", bowlingCashRevenue: "", gastroCashRevenue: "", revenueDrinks: "", revenueFood: "", revenueOther: "", revenueGastro: "", barBowling: "", barGastro: "", tipTotal: "", tipRemainder: "", tipPayoutConfirmedAt: "", tipPayoutAmount: "", tipPayoutRemainder: "", tipsByEmployee: {}, invoiceCustomers: [], expenses: [], miscIncome: [], documents: {}, notes: "", extraEmployees: [], removedEmployees: [], handovers: [], taskCompletions: {}, cleaningCompletions: {}, toiletChecks: [], reminderChecks: [], terminalMessageChecks: [], tableReservations: [], tableGroups: [], tableStaffAssignments: [], ...report };
}
